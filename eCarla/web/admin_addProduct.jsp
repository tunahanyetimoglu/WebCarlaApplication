    ...
    <body>
        ...
        <div class="container_16">
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                ...
                <div class="grid_3">
                        <br/><h1>Step 1. Enter Car Company</h1><hr/>
                    </div>
                <div class="grid_3">
                        <br/><h1>Step 2. Enter Category</h1><hr/>
                    </div>
                <div class="grid_3">
                        <br/><h1>Step 3. Enter in Car Name, Tags</h1><hr/>
                    </div>
                <div class="grid_3">
                ...
                <div class="grid_13"  style="padding: 10px 0px;" id="whiteBox">
                    <div class="grid_13">
                        <br/><h1>4 Step Process for Adding Cars...</h1><hr/>
                    </div>
                    
                    <div class="grid_7">
                        <a style="
border: 1px solid black;
box-shadow: 0px 2px 10px #333;" href="admin_addProduct_1.jsp" class="grid_5 push_2" id="buy">Start Adding Cars right Now...!</a>
                    </div>
                </div>
