        ...
        <div class="grid_16">
            ...
            <div class="grid_6" id="top">
                <ul>
                    ...
                    <a href="admin_.jsp" id="join"><li id="greenBtn"  class ="Btn showForm">Admin Login</li></a>
                </ul>
            </div>
        </div>
    </div>
                ...
                <form autocomplete="false" method="post" action="loginServlet"  name="login">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="email" placeholder="login@abc.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <form autocomplete="false" method="POST" action="register" name="registerServlet">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="email" name="emailReg" placeholder="register@abc.com" required/><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
