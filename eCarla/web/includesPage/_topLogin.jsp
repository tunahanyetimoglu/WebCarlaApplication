                ...
                <form method="POST" action="login"  name="loginForm">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="text" name="email" placeholder="login@xyz.com" /><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label>Admin Login</label>
                                  <a href="admin_.jsp">Admin Login</a>  
                            </td>
                ...
                <form method="POST" action="register" name="registerForm">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="text" name="email" placeholder="register@xyz.com" /><br/></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
