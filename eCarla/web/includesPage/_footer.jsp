<div id = "footer">
    <div class="container_16">
        <div class="grid_16" >
            ...
            <div class="grid_3">
                <ul>
                    ...
                    <li><a href="contact-support.jsp">Careers</a></li>
                </ul>
            </div>
            <div class="grid_3">
                <ul>
                    ...
                    <li><a href="https://www.facebook.com/tunahan.yetimoglu">Facebook</a></li>
                </ul>
            </div>
            <div class="grid_5">
        ...
        <div id="clear"></div>
        <div class="grid_16">	
            <p>Copyrights &copy; 2018 Tunahan Yetimoglu&Omer Ozen&Umit Salman </p>
    </div>
</div>
</div>